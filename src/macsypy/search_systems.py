...
from .registries import ModelRegistry, DefinitionLocation
from .system import System, LikelySystem, RejectedCandidate, UnlikelySystem, OrderedMatchMaker, UnorderedMatchMaker
...
from .search_genes import search_genes
from .hit import get_best_hits, HitWeight, MultiSystem, LonerMultiSystem, sort_model_hits, compute_best_MSHit
from .solution import combine_clusters, combine_multisystems
from .cluster import build_clusters, Cluster
...
def search_in_ordered_replicon(hits_by_replicon: dict[str: list[macsypy.hit.CoreHit]],
    ...
    for rep_name in hits_by_replicon:
        ...
        for model in models_to_detect:
            ...
            true_clusters, true_loners = build_clusters(mhits_related_one_model, rep_info, model, hit_weights)
...
def search_in_unordered_replicon(hits_by_replicon: dict[str: list[macsypy.hit.CoreHit]],
                                 models_to_detect: list[macsypy.model.Model],
